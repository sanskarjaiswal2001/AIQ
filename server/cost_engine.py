...
def interpret_cost(summary: dict[str, Any], plan_context: dict[str, Any]) -> dict[str, Any]:
    ...
    if billing_mode == "api":
        ...
        result["display_cost"] = seat_cost_usd
        result["cost_label"] = "Monthly Seat Cost"
        ...
        result["display_cost"] = estimated_cost
        result["cost_label"] = "Rolling Window Usage"
        ...
        result["display_cost"] = estimated_cost
        result["cost_label"] = "Credits Consumed (est.)"
        ...
        result["display_cost"] = seat_cost_usd + api_overage
